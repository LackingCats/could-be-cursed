...
import net.nospacehuman.cbc.item.custom.FederalisedOreFinderItem;
import net.nospacehuman.cbc.item.custom.TotalitarianiteShrapnelItem;
...
public class ModItems {
    ...
    public static final Item TOTALITARIANITE_SHRAPNEL = registerItem("totalitarianite_shrapnel", new TotalitarianiteShrapnelItem(new FabricItemSettings().group(ItemGroup.MATERIALS).maxDamage(1)));
    public static final Item TOTALITARIANITE_NUGGET = registerItem("totalitarianite_nugget",
    ...
    public static final Item FEDERALISED_ORE_FINDER = registerItem("federalised_ore_finder", new FederalisedOreFinderItem(new FabricItemSettings().group(ItemGroup.TOOLS).maxCount(1).maxDamage(666)));
